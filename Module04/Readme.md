...
- [ ] Creating command line prompts ./file.c name ID course_name campus . Can we create some basic scanf file that we can use to fill some data, such as the following and print the same in specific toString type format.
  * name of student
  * student ID
  * courses registered
  * campus
